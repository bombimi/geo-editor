...
export const WellKnownProperties: { [key: string]: DocumentPropertyMetadata } = {
    // Internal properties
    __meta_guid: { type: "string", readonly: true, displayName: "UniqueId", group: "Metadata" },
    __meta_type: { type: "string", readonly: true, displayName: "Type", group: "Metadata" },
    ...
    "marker-symbol": { group: "Marker style", type: "string", displayName: "Marker Symbol" },
    "stroke-width": {
        group: "Stroke style",
        type: "number",
        min: 0,
    ...
    styleHash: { group: "Style", type: "string", displayName: "Style Hash", readonly: true },
...
export const WellKnownPropertiesArray = Object.entries(WellKnownProperties).map(
